...
class WebSearchAgentTool(BaseTool):
    ...
    description: str = "An agent that can search the web and return information to answer the user's question."
    SERPAPI_API_KEY: Optional[str] = Field(default=os.getenv("SERPAPI_API_KEY"))
